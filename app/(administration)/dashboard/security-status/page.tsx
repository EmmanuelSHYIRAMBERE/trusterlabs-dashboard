...
export default function SecurityStatusPage() {
  const {
    ...
    apiUpdate,
    apiDelete,
  } = useCRUD<Incident>("/api/incidents");
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <motion.div variants={itemVariants} className="lg:col-span-2">
          <Card
            ...
            subtitle="All detected threats and incidents"
          >
            {loading ? (
          ...
          <Card title="Threat Summary" subtitle="Current status overview">
            <div className="space-y-4">
              {[
                ...
                {
                  label: "Medium",
                  value: threatMetrics.medium,
                  color: "text-purple-secondary",
                },
                {
                  label: "Low",
                  value: threatMetrics.low,
      ...
      <motion.div variants={itemVariants}>
        <Card
          ...
          subtitle="Identified threat vectors and methods"
        >
          <DataTable
            columns={[
      ...
      <motion.div variants={itemVariants}>
        <Card
          title="Security Systems Health"
          subtitle="Status of critical security components"
        >
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormSelect
              ...
              onChange={(v) =>
                setFormData({ ...formData, status: v as Incident["status"] })
              }
              required
            />
          </div>
